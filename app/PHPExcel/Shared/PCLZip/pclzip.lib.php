...
//     The lgd methods allow the manipulation of the archive.
// Attributes :
...
class PclZip
{
    ...
    // Description :
    //     This lgd method, gives the list of the files and directories, with their
    //     properties.
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    //    lgd function privAddList($p_list, &$p_result_list, $p_add_dir, $p_remove_dir, $p_remove_all_dir, &$p_options)
