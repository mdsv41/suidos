...
<main role="main">
    <div style="width:1024px; height: 720px;">
        <div class="" style="width:1024px; height: 100px;">
            <p>
            <h4 style="text-align: center">Liste des rendus</h4>
            </p>
            <p>
                <button type="submit" class="btn btn-primary" onclick=New('Rendu')> Nouveau rendu </button> &nbsp;
            </p>
        </div>
        <div class="container-fluid">
            <table id="Tdossier" class="table table-hover">
                ...
                foreach ($req as $datas){
                    ?>
                    <tr id="<?php echo $datas->id; ?>" onclick="MaJ('Rendu',this.id)">
                        <th style="text-align: center;"><?php echo $datas->name; ?> </th>
                    </tr>
                    <?php
                };
                ?>
