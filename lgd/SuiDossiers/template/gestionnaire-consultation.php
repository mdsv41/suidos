<div class="gestionnaire" style="font-size: 1.07em ">
  <div style="border: solid 5px #C481B2; padding: 10px 0 10px 0; font-size: 75%" class="container">
    ...
    <div class="row">
      ...
      <div class="col-3" style="text-align: left">
        <?= $datas->domaine ?>
        <select hidden id="dom_intervention" class="gest hidden" name="domaine" style="width: 160px;">
        ...
        <br>
        <?= $datas->type_voie ?>
        <select hidden id="type_voie" class="gest hidden" name="type_voie" style="width: 160px;">
          <?php
        ...
        <br>
        <?= affiche_date($prestation) ?>
        <input hidden  title="" type="text" class="datepicker gest hidden" name="prestation_date" value="<?php echo affiche_date($prestation) ?>" style="width: 160px" hidden="hidden">
      </div>
      ...
      <div class="clo-4" style="text-align: left">
        <?= $datas->Suite_Donnee ?>
        <select hidden id="Suite_Donner" class="gest hidden" type="text" name="Suite_Donnee" size="1" style="width: 100px;" >
          <option> </option>
        ...
        <br>
        <?= $datas->contrainte ?>
        <select hidden id="contrainte" class="gest hidden" name="contrainte">
        <option> </option>
        ...
        <?= $datas->contrainte_date ?>
        <input hidden title="" class="gest hidden" type="text" name="contrainte_date" value="<?php echo $datas->contrainte_date; ?>" style="width: 98px; text-align: center">
        <br>
        <?= $datas->commande ?>
        <input hidden id="" type="text" name="commande" value="<?php echo $datas->commande; ?>" class="gest hidden" size="10">
        &nbsp;
        <?= $datas->echeance ?>
        <label for="echeance">Echéance :</label>
        <input hidden id="echeance" name="echeance" value="<?php echo affiche_date($datas->echeance); ?>" class="datepicker gest hidden" size="10">
      </div>
      <div class="w-100"></div>
      <div class="col-2" style="text-align: right">
      ...
      <div class="col-10">
        <?= $datas->objet ?>
        <input hidden id="objet" type="text" class="gest" value="<?php echo $datas->objet ?>" name="objet" style="width: 609px">
        <br>
  ...
  <div class="container" style="border: solid 5px #C481B2; padding: 10px 0 10px 0;font-size: 75%">
    ...
    <div class="row">
      ...
      <div class="col-3" style="text-align: center">
        <?= $datas->d1_facture ?>
        <select hidden id="d1_facture" type="text" class="table-bordered gest hidden" name="d1_facture" size="1" style="width: 175px;">
          <?php
      ...
      <div class="col-3" style="text-align: center">
        <?= $datas->d2_facture ?>
        <select hidden id="d2_facture" type="text" class="table-bordered gest hidden" name="d2_facture" size="1" style="width: 175px;">
          <?php
      ...
      <div class="col-3" style="text-align: center">
        <?= $datas->d3_facture ?>
        <select hidden id="d3_facture" type="text" class="table-bordered gest hidden" name="d3_facture" size="1" style="width: 175px;">
          <?php
      ...
      <div class="col-3"style="text-align: center">
        <?= $datas->d1_mission ?>
        <select hidden id="d1_mission" type="text" class="table-bordered gest hidden" name="d1_mission" size="1" style="width: 175px;">
          <?php
      ...
      <div class="col-3" style="text-align: center">
        <?= $datas->d2_mission ?>
        <select hidden id="d2_mission" type="text" class="table-bordered gest hidden" name="d2_mission" size="1" style="width: 175px;">
          <?php
          $req = $db->query('SELECT * FROM mission');
          foreach ($req as $opmission){
      ...
      <div class="col-3" style="text-align: center">
        <?= $datas->d3_mission ?>
        <select hidden id="d3_mission" type="text" class="table-bordered gest hidden" name="d3_mission" size="1" style="width: 175px;">
          <?php
          $req = $db->query('SELECT * FROM mission');
          foreach ($req as $opmission){
      ...
      <div class="col-3"style="text-align: center">
        <?= $datas->d1_prestation ?>
        <select hidden id="d1_prestation" type="text" class="table-bordered gest hidden" name="d1_prestation" size="1" style="width: 175px;">
          <?php
      ...
      <div class="col-3" style="text-align: center">
        <?= $datas->d2_prestation ?>
        <select hidden id="d2_prestation" type="text" class="table-bordered gest hidden" name="d2_prestation" size="1" style="width: 175px;">
          <?php
          $req = $db->query('SELECT * FROM prestation');
          foreach ($req as $opprestation){
      ...
      <div class="col-3" style="text-align: center">
        <?= $datas->d3_prestation ?>
        <select hidden id="d3_prestation" type="text" class="table-bordered gest hidden" name="d3_prestation" size="1" style="width: 175px;">
          <?php
          $req = $db->query('SELECT * FROM prestation');
          foreach ($req as $opprestation){
      ...
      <div class="col-3"style="text-align: center">
        <?= $datas->d1_rendu ?>
        <select hidden id="d1_rendu" type="text" class="table-bordered gest hidden" name="d1_rendu" size="1" style="width: 175px;">
          <?php
      ...
      <div class="col-3" style="text-align: center">
        <?= $datas->d2_rendu ?>
        <select hidden id="d2_rendu" type="text" class="table-bordered gest hidden" name="d2_rendu" size="1" style="width: 175px;">
          <?php
          $req = $db->query('SELECT * FROM rendu');
          foreach ($req as $oprendu){
      ...
      <div class="col-3" style="text-align: center">
        <?= $datas->d3_rendu ?>
        <select hidden id="d3_rendu" type="text" class="table-bordered gest hidden" name="d3_rendu" size="1" style="width: 175px;">
          <?php
          $req = $db->query('SELECT * FROM rendu');
          foreach ($req as $oprendu){
      ...
      <div class="col-3"style="text-align: center">
        <?= $datas->d1_charge ?>
        <select hidden id="d1_charge" type="text" class="table-bordered gest hidden" name="d1_charge_affaire"  size="1" style="width: 175px;">
          <?php
      ...
      <div class="col-3" style="text-align: center">
        <?= $datas->d2_charge ?>
        <select hidden id="d2_charge" type="text" class="table-bordered gest hidden" name="d2_charge_affaire"  size="1" style="width: 175px;">
      ...
      <div class="col-3" style="text-align: center">
        <?= $datas->d3_charge ?>
        <select hidden id="d3_charge" type="text" class="table-bordered gest hidden" name="d3_charge_affaire"  size="1" style="width: 175px;">
          <option selected></option>
          <?php
