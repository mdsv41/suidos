...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      $res = $db->query("SELECT * FROM genese WHERE Affichage = FALSE ORDER BY saisie_date ASC");
      if (empty($res)){
        ?>
      ...
      ?>
      <li class="nav-item">
        <a class="nav-link disabled active" href="../SuiGenese/attente.php">Validation</a>
      </li>
      <?php
      if(substr($_SESSION['level'],0,1)== "1") {
        ?>
        <li class="nav-item">
          <a class="nav-link disabled" href="../SuiDossiers/index.php">Dossiers</a>
        </li>
        <?php
      }
      if(substr($_SESSION['level'],4,1)== "1") {
        ?>
        <li class="nav-item">
