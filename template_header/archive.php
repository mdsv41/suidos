  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      if(substr($_SESSION['level'],2,1)== "1") {
        ?>
        <li class="nav-item">
          <a href="../SuiDossiers/archiveListe.php" class="nav-link active">Archives</a>
        </li>
        <?php
      }else{
        ?>
      ...
      if(substr($_SESSION['level'],0,1)== "1") {
        ?>
        <li class="nav-item">
          <a class="nav-link" href="../SuiEstimations/index.php">Estimations</a>
        </li>
        <?php
      }
    ...
    <div class="my-2 my-lg-0">
      <?php if(substr($_SESSION['level'],4,1)== "1") { ?>
        <a href="./tdb/tdb-tech.php" class="btn btn-secondary my-2 my-sm-0" role="button" aria-pressed="true">TdB Technique</a>
      <?php }
      if(substr($_SESSION['level'],5,1)== "1") { ?>
        <a href="./tdb/tdb-activite.php" class="btn btn-secondary my-2 my-sm-0" role="button" aria-pressed="true">TdB Activité</a>
      <?php } ?>
